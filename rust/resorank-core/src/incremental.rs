...
use crate::config::{CorpusStatistics, FieldId, ResoRankConfig, F32, U32, Usize};
use crate::math::{calculate_idf, normalized_term_frequency, saturate};
use crate::proximity::{
    global_proximity_multiplier, idf_weighted_proximity_multiplier, pairwise_proximity_bonus,
    ProximityStrategy,
};
use crate::types::{FieldAccumulator, IncrementalDocumentAccumulator, TermWithIdf};
