        ...
        <div className="space-y-1">
          {entityTypes.map((entityType) => (
            <button
              ...
              onClick={() => setSelectedEntityTypeId(entityType.entity_type_id)}
              className={`w-full text-left px-3 py-2 rounded-md text-sm transition-colors ${
                selectedEntityTypeId === entityType.entity_type_id
            ...
            >
              <div className="flex items-center gap-2">
                ...
                />
                <span className="truncate">{entityType.display_name}</span>
              ...
              <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
                ...
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Define a new field for {selectedEntityType.display_name}.
                    </DialogDescription>
                  </DialogHeader>
                  <div className="space-y-4 py-4">
                    ...
                    <div className="flex gap-4">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        />
                        <Label htmlFor="is_array" className="font-normal">Array</Label>
                      </div>
                    </div>
